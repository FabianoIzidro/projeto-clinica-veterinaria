...
<body id = "tela">
    ...
    <div id ="conteudo-principal" >
        <a href="voltar_A"><input type = "submit" value="Voltar" class= "button2" /></a>
        <a href="telalogin_A"><input type = "submit" value="Tela Login" class= "button2" /></a>
        <a href="listar_A"><input type = "submit" value="Listar" class= "button2" /></a>

    <tr width="100%">
    <td width="30%" align="center"><img src ="{{asset("imagem/vet(1).jpg")}}" class ="imagem"/></td>
    </tr>       
<form action= "{{route('editar_A', ['id' => $animal['id']])}}" method="POST">
    @csrf
    <div clear = "both"> 
